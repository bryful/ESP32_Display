#pragma once
#ifndef LGFX_esp32_s3_fh4r2_SPI_ST7789_HPP
#define LGFX_esp32_s3_fh4r2_SPI_ST7789_HPP
#include <LovyanGFX.hpp>

// ESP32でLovyanGFXを独自設定で利用する場合の設定例

/// 独自の設定を行うクラスを、LGFX_Deviceから派生して作成します。
class LGFX_esp32_s3_fh4r2_SPI_ST7789_28 : public lgfx::LGFX_Device
{
    /*
...
public:
    ...
    LGFX_esp32_s3_fh4r2_SPI_ST7789_28(void)
    {
        {                                      // バス制御の設定を行います。
            ...
            cfg.spi_mode = 033;                // SPI通信モードを設定 (0 ~ 3) CSのないディスプレはSPIモード3にしてください。
            ...
            cfg.pin_dc = 10;   // SPIのD/Cピン番号を設定  (-1 = disable)
